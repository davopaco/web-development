...
makeModule() {
  ...
  mkdir -p ${src}/${app} ${src}/${app}/shared ${src}/${app}/helper ${src}/${app}/util
  mkdir -p ${src}/${app}/application ${src}/${app}/application/service ${src}/${app}/application/usecase
  mkdir -p ${src}/${app}/domain ${src}/${app}/domain/model ${src}/${app}/domain/port ${src}/${app}/domain/port/driver ${src}/${app}/domain/port/driven
  mkdir -p ${src}/${app}/infrastructure ${src}/${app}/infrastructure/config
